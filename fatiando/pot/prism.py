...
* :func:`~fatiando.pot.prism.pot`
* :func:`~fatiando.pot.prism.gx`
* :func:`~fatiando.pot.prism.gy`
* :func:`~fatiando.pot.prism.gz`
* :func:`~fatiando.pot.prism.gxx`
* :func:`~fatiando.pot.prism.gxy`
* :func:`~fatiando.pot.prism.gxz`
* :func:`~fatiando.pot.prism.gyy`
* :func:`~fatiando.pot.prism.gyz`
* :func:`~fatiando.pot.prism.gzz`

**Magnetic**

The Total Field anomaly is calculated using the formula of Bhattacharyya (1964).

* :func:`~fatiando.pot.prism.tf`
