...
* :func:`~fatiando.pot.sphere.tf`: calculates the total-field anomaly
...
:func:`~fatiando.pot.sphere.bx`, :func:`~fatiando.pot.sphere.by`,
and :func:`~fatiando.pot.sphere.bz` calculate the 3 components of the
