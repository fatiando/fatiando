...
* :func:`~fatiando.pot.polyprism.gz`
* :func:`~fatiando.pot.polyprism.gxx`
* :func:`~fatiando.pot.polyprism.gxy`
* :func:`~fatiando.pot.polyprism.gxz`
* :func:`~fatiando.pot.polyprism.gyy`
* :func:`~fatiando.pot.polyprism.gyz`
* :func:`~fatiando.pot.polyprism.gzz`

**Magnetic**

The Total Field magnetic anomaly:

* :func:`~fatiando.pot.polyprism.tf`
