/* **************************************************************************
   Interface file for generation SWIG wrappers around 'linalg.c'
...
%define DOCSTRING
" C-coded set of linear algebra functions for use in inverse problems.

Author: Leonardo Uieda
Date: 01 March 2010
Last Update: $Date: 2010-03-19 14:30:43 -0300 (Fri, 19 Mar 2010) $
$Revision: 16 $
"
%enddef
/* Declare the module name */
%module(docstring=DOCSTRING) linalg
...
Ex:
    ...
    lu = lu_decomp_nopivot(matrix)


NOTE: The pivoting alternative to this function is prefered because it was more extensively tested. See lu_decomp documentation for more details.
"
%enddef
...
Ex:
    ...
    lu, p = lu_decomp(matrix)
    
NOTE: For a non-pivoting version of lu_decomp, see docs for lu_decomp_nopivot
"
%enddef
...
EX:
    ...
    lu, p = lu_decomp(A)
    x = solve_linsys_lu(lu, p, y)
"
%enddef

%feature("docstring", SOLVE_LINSYS_LUDOC);

extern int solve_linsys_lu(double *lu, int dim, int *permut, double *y, double *x);
/* ************************************************************************** */
