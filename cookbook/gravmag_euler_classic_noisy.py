...
model = [
    ft.mesher.Prism(-500, 500, -500, 500, 1000, 2000, {'magnetization':2})]
...
tf = (ft.utils.contaminate(
        ft.utils.nt2si(ft.gravmag.prism.tf(xp, yp, zp, model, inc=-45, dec=0)),
        0.005, percent=True)
      + baselevel)
...
results = ft.gravmag.euler.classic(xp, yp, zp, tf, xderiv, yderiv, zderiv, 3)
