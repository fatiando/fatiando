...
gxy = ft.utils.contaminate(ft.gravmag.prism.gxy(x, y, z, model), 1)
gzz = ft.utils.contaminate(ft.gravmag.prism.gzz(x, y, z, model), 1)
# Create a prism mesh
mesh = PrismMesh(bounds, (20, 50, 50))
# Make the data modules
datamods = ft.gravmag.harvester.wrapdata(mesh, x, y, z, gxy=gxy, gzz=gzz)
# and the seeds
