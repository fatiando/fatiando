...
gz = ft.utils.contaminate(ft.gravmag.prism.gz(xp, yp, zp, prisms), 0.001)
...
gxz = ft.utils.si2eotvos(
    ft.gravmag.fourier.derivx(xp, yp, ft.utils.mgal2si(gz), shape))
gyz = ft.utils.si2eotvos(
    ft.gravmag.fourier.derivy(xp, yp, ft.utils.mgal2si(gz), shape))
gzz = ft.utils.si2eotvos(
    ft.gravmag.fourier.derivz(xp, yp, ft.utils.mgal2si(gz), shape))

log.info("Computing true values of the derivative")
gxz_true = ft.gravmag.prism.gxz(xp, yp, zp, prisms)
gyz_true = ft.gravmag.prism.gyz(xp, yp, zp, prisms)
gzz_true = ft.gravmag.prism.gzz(xp, yp, zp, prisms)
