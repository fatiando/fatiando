"""
Seis: SRTomo: 2D straight-ray tomography using damping regularization
...
estimate, residuals = ft.seis.srtomo.run(tts, srcs, recs, mesh, damping=10**9)
...
ft.vis.axis('scaled')
ft.vis.title('Tomography result (damped)')
