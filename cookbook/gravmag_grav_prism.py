...
fields = [ft.gravmag.prism.potential(xp, yp, zp, prisms),
          ft.gravmag.prism.gx(xp, yp, zp, prisms),
          ft.gravmag.prism.gy(xp, yp, zp, prisms),
          ft.gravmag.prism.gz(xp, yp, zp, prisms),
          ft.gravmag.prism.gxx(xp, yp, zp, prisms),
          ft.gravmag.prism.gxy(xp, yp, zp, prisms),
          ft.gravmag.prism.gxz(xp, yp, zp, prisms),
          ft.gravmag.prism.gyy(xp, yp, zp, prisms),
          ft.gravmag.prism.gyz(xp, yp, zp, prisms),
          ft.gravmag.prism.gzz(xp, yp, zp, prisms)]
log.info("Plotting...")
