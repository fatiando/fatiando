...
def test_density_matrix_input():
    ...
    rc_int=conv.calc_RC(vel_l_int,rho_l_int)
    synt_int = conv.seismic_convolutional_model(rc_int, 30., conv.rickerwave)
    ...
    rc_mat=conv.calc_RC(vel_l_mat,rho_l_mat)
    synt_mat = conv.seismic_convolutional_model(rc_mat, 30., conv.rickerwave) 
...
def test_impulse_response():
    ...
    spike=conv.seismic_convolutional_model(RC_test, 30., conv.rickerwave)
