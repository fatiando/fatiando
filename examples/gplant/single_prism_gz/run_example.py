...
utils.set_logfile('prism_example.log')
...
model = []
model.append({'x1':1000, 'x2':2000, 'y1':1000, 'y2':2000, 'z1':2000, 'z2':4000,
               'value':1000})
...
seeds = []
seeds.append(gplant.get_seed((1501, 1501, 3501), 1000, mesh))
seeds.append(gplant.get_seed((1501, 1501, 2501), 1000, mesh))
