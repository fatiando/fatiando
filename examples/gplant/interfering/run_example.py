...
utils.set_logfile('interfering_example.log')
...
model.append({'x1':1300, 'x2':2000, 'y1':1400, 'y2':2600, 'z1':200, 'z2':800,
              'value':1000})
model.append({'x1':500, 'x2':2000, 'y1':200, 'y2':700, 'z1':200, 'z2':800,
              'value':1000})
...
seeds.append(gplant.get_seed((701, 551, 501), 1000, mesh))
seeds.append(gplant.get_seed((1501, 551, 501), 1000, mesh))
