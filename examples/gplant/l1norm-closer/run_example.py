...
model.append({'x1':1300, 'x2':2000, 'y1':1300, 'y2':2400, 'z1':200, 'z2':800,
              'value':1000})
model.append({'x1':800, 'x2':1300, 'y1':300, 'y2':1700, 'z1':200, 'z2':800,
              'value':-1000})
model.append({'x1':2000, 'x2':2700, 'y1':1000, 'y2':2000, 'z1':200, 'z2':600,
              'value':-1000})
...
# Run the inversion
results = gplant.grow(data, mesh, seeds, compactness=10**(15), power=7,
